...
<p align="center">
    ...
    <a href="https://swift.org/package-manager">
     ...
     <img src="https://img.shields.io/badge/platforms-mac+linux-brightgreen.svg?style=flat" alt="Apple platforms + Linux" />
</p>
...
This project is a fork of the original upstream [Ink](https://github.com/JohnSundell/Ink). 
...
Ink targets macOS Catalina (10.15) or later. To build Ink, make sure that Swift 6.2 (or later) is installed. If you’re using a Mac, also make sure that `xcode-select` points to an Xcode installation that includes the required Swift toolchain.
...
Ink was originally written by [John Sundell](https://x.com/johnsundell) as part of the Publish suite of static site generation tools, which is used to build and generate [Swift by Sundell](https://swiftbysundell.com). The other tools that make up the Publish suite will also be open sourced soon.

The Markdown format was created by [John Gruber](https://x.com/gruber). You can find [more information about it here](https://daringfireball.net/projects/markdown).
